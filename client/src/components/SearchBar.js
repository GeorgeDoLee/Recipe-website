...
const SearchBar = ({defaultFilters, placeholder}) => {
  ...
  return (
    <section className='container px-24 mt-8'>
      <div className='flex items-center justify-between w-full mx-auto'>
        <button onClick={() => navigate('/add-recipe')} className='p-2 border rounded-md border-blue-rich'>
          Add Recipe
        </button>
        <form
          className='flex items-center gap-4 text-blue-rich' 
